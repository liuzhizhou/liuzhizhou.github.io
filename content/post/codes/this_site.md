...
如果你也需要/想要一个类似的个人博客，可以参考[这个网页](https://pingfan.me/posts/cs/create_blog_with_zero_experience/)和[这个Youtube视频](https://www.youtube.com/watch?v=dbtMf3kXUfw&t=754s)。超级友好地，利用[Hugo](Hugo<https://gohugo.io)和GitHub的Personal> Page功能，实现了个人博客的需求。
